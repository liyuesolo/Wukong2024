...
void EoLRodSim::addJointBendingAndTwistingK(std::vector<Entry>& entry_K)
{
...
void EoLRodSim::addJointBendingAndTwistingForce(Eigen::Ref<VectorXT> residual)
{
...
T EoLRodSim::addJointBendingAndTwistingEnergy(bool bending, bool twisting)
{
    T energy = 0.0;
    for (auto& crossing : rod_crossings)
    {
