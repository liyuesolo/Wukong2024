...
void IMLSContact::buildIPCRestData()
{
...
void IMLSContact::addIPCForceEntries(VectorXT& residual)
{
    Eigen::MatrixXd ipc_vertices_deformed = ipc_vertices;
...
void IMLSContact::addIPCHessianEntries(std::vector<Entry>& entries)
{
    Eigen::MatrixXd ipc_vertices_deformed = ipc_vertices;
...
void IMLSContact::updateIPCVertices()
{
...
T IMLSContact::computeCollisionFreeStepsize(const VectorXT& du)
{
...
void IMLSContact::updateBarrierInfo(bool first_step)
{
