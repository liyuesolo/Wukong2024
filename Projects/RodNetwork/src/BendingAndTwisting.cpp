...
// T RodNetwork::add3DBendingAndTwistingEnergy(bool bending, bool twisting)
// {
//     T energy = 0.0;
//     for (auto& rod : Rods)
//     {
...
// void RodNetwork::add3DBendingAndTwistingForce(Eigen::Ref<VectorXT> residual)
// {
...
// void RodNetwork::add3DBendingAndTwistingK(std::vector<Entry>& entry_K)
// {
//     for (auto& rod : Rods)
//     {
//         rod->iterate3NodesWithOffsets([&](int node_i, int node_j, int node_k, 
